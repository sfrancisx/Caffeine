...
@property NSInteger soundVolume;  // the sound output volume (0 = minimum, 100 = LOG_MAXIMUM)
...
@property NSInteger soundVolume;  // the output volume for the device (0 = minimum, 100 = LOG_MAXIMUM)
